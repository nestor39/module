...
# YOUR CODE HERE!
quantity_of_loans = len(loan_costs)
print(f"The total number of loans is: {quantity_of_loans}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
# YOUR CODE HERE!
the_total_of_loans_is = sum(loan_costs)
print(f"The total loan amount is: {the_total_of_loans_is}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
Average_of_loans = sum(loan_costs)/len(loan_costs)
...
# YOUR CODE HERE!
required_return = 0.2
present_value = future_value / (1 + required_return / 12) ** remaining_months
print(f"present value with 20% of discount rate is: {present_value: .02f}")

#present_value = loan.get("future_value") / (1+ 0.2/12) ** loan.get("remaining_months")
#print("present value with 20% of discount rate is: {present_value}")
...
# YOUR CODE HERE!
for new_list in loans:
    if new_list.get("loan_price") <= 500:
        inexpensive_loans.append(new_list)
...
with open(output_path, 'w', newline='') as csvfile:
   ...
   # Write our header row first!
    ...
    for row in inexpensive_loans:
        ...
        #number145, 86, 87, 99 real cost? equations are right ???